 ...
 * @author Nadia
 */
public class FrmFilterNaziv extends javax.swing.JDialog {
	JFrame parent;

	/**
	 * Creates new form FrmFilterNaziv
	 */
	public FrmFilterNaziv(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGroup(layout
								...
								.addGroup(layout.createSequentialGroup().addComponent(jLabel1).addGap(18, 18, 18)
										.addComponent(txtNaziv, javax.swing.GroupLayout.PREFERRED_SIZE, 255,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(69, 69, 69).addComponent(btnPretrazi))
	...
	private void btnPretraziActionPerformed(java.awt.event.ActionEvent evt) {
		...
		kz.setOperacija(Operacije.NADJI_RECEPT_PREMA_NAZIVU);
		...
		if (so.isUspesno()) {
			...
			uspesno = false;
			JOptionPane.showMessageDialog(this, "nismo uspeli da nadjemo recepte sa imenom");
			return;
		}
	...
	private void sredi() {
		this.setTitle("Pretraživanje recepta prema nazivu");
